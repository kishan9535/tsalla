    ...
    <section className="px-4 pb-24 max-w-7xl mx-auto">
      ...
      <div className="mb-16">
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-semibold mb-4">Our Hiring Process</h2>
          <p className="text-gray-400 text-lg max-w-3xl mx-auto">
            We believe in a transparent, efficient hiring process that respects your time while ensuring the right fit
            for both parties.
          </p>
        </div>
