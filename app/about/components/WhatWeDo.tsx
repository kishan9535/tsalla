      ...
      <section className="bg-black text-white py-24 px-4 md:px-8">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-12">
          ...
          <div className="w-full md:w-1/2 text-right flex flex-col items-end justify-center">
            <h2 className="text-4xl md:text-5xl font-semibold mb-6 tracking-tight">WHAT WE DO</h2>
            <p className="text-gray-300 leading-relaxed text-sm md:text-base max-w-md">
              ...
              civil missions and combat-ready roles, they carry more than technology — they carry trust. Through
              vision and design excellence, we’re helping India own its place in the skies.
            </p>
          </div>
        </div>
      </section>
